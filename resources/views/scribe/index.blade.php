...
<p>Get explainations for all returned values. Default: <code>false</code></p>            </p>
            ...
            <h2 id="masternode-GETv1-masternode-all">all active Masternodes</h2>
...
<span id="example-requests-GETv1-masternode-all">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request GET \
    --get "https://defichain-api.io/v1/masternode/all?stats=1&amp;wtf=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-php">$client = new \GuzzleHttp\Client();
$response = $client-&gt;get(
    'https://defichain-api.io/v1/masternode/all',
    [
        'headers' =&gt; [
            'Accept' =&gt; 'application/json',
        ],
...
url = 'https://defichain-api.io/v1/masternode/all'
params = {
  'stats': '1',
  'wtf': '1',
}
...
<span id="example-responses-GETv1-masternode-all">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETv1-masternode-all" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETv1-masternode-all"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETv1-masternode-all"></code></pre>
</span>
<span id="execution-error-GETv1-masternode-all" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETv1-masternode-all"></code></pre>
</span>
<form id="form-GETv1-masternode-all" data-method="GET"
      data-path="v1/masternode/all"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETv1-masternode-all', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>v1/masternode/all</code></b>
        </p>
                        <h4 class="fancy-heading-panel"><b>Query Parameters</b></h4>
                    <p>
                <b><code>stats</code></b>&nbsp;&nbsp;<small>boolean</small>     <i>optional</i> &nbsp;
                <label data-endpoint="GETv1-masternode-all" hidden>
            <input type="radio" name="stats"
                   value="1"
                   data-endpoint="GETv1-masternode-all"
                   data-component="query"             >
            <code>true</code>
        </label>
        <label data-endpoint="GETv1-masternode-all" hidden>
...
<p>Get explainations for all returned values. Default: <code>false</code></p>            </p>
            ...
            <h2 id="masternode-GETv1-masternode--state--all">Masternodes with requested state</h2>
...
<span id="example-requests-GETv1-masternode--state--all">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request GET \
    --get "https://defichain-api.io/v1/masternode/resigned/all?stats=1&amp;wtf=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-php">$client = new \GuzzleHttp\Client();
$response = $client-&gt;get(
    'https://defichain-api.io/v1/masternode/resigned/all',
    [
        'headers' =&gt; [
            'Accept' =&gt; 'application/json',
        ],
...
url = 'https://defichain-api.io/v1/masternode/resigned/all'
params = {
  'stats': '1',
  'wtf': '1',
}
...
<span id="example-responses-GETv1-masternode--state--all">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETv1-masternode--state--all" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETv1-masternode--state--all"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETv1-masternode--state--all"></code></pre>
</span>
<span id="execution-error-GETv1-masternode--state--all" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETv1-masternode--state--all"></code></pre>
</span>
<form id="form-GETv1-masternode--state--all" data-method="GET"
      data-path="v1/masternode/{state}/all"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETv1-masternode--state--all', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>v1/masternode/{state}/all</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
                <b><code>state</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
                <input type="text"
               name="state"
               data-endpoint="GETv1-masternode--state--all"
               data-component="url" required  hidden>
    <br>
<p>Select all masternodes with the given state.</p>            </p>
                        <h4 class="fancy-heading-panel"><b>Query Parameters</b></h4>
                    <p>
                <b><code>stats</code></b>&nbsp;&nbsp;<small>boolean</small>     <i>optional</i> &nbsp;
                <label data-endpoint="GETv1-masternode--state--all" hidden>
            <input type="radio" name="stats"
                   value="1"
                   data-endpoint="GETv1-masternode--state--all"
                   data-component="query"             >
...
<p>Get explainations for all returned values. Default: <code>false</code></p>            </p>
            ...
            <h2 id="masternode-GETv1-masternode-with_inactive-all">active Masternodes</h2>
...
<span id="example-requests-GETv1-masternode-with_inactive-all">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request GET \
    --get "https://defichain-api.io/v1/masternode/with_inactive/all?stats=1&amp;wtf=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-php">$client = new \GuzzleHttp\Client();
$response = $client-&gt;get(
    'https://defichain-api.io/v1/masternode/with_inactive/all',
    [
        'headers' =&gt; [
            'Accept' =&gt; 'application/json',
        ],
...
url = 'https://defichain-api.io/v1/masternode/with_inactive/all'
params = {
  'stats': '1',
  'wtf': '1',
}
...
<span id="example-responses-GETv1-masternode-with_inactive-all">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETv1-masternode-with_inactive-all" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETv1-masternode-with_inactive-all"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETv1-masternode-with_inactive-all"></code></pre>
</span>
<span id="execution-error-GETv1-masternode-with_inactive-all" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETv1-masternode-with_inactive-all"></code></pre>
</span>
<form id="form-GETv1-masternode-with_inactive-all" data-method="GET"
      data-path="v1/masternode/with_inactive/all"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETv1-masternode-with_inactive-all', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>v1/masternode/with_inactive/all</code></b>
        </p>
                        <h4 class="fancy-heading-panel"><b>Query Parameters</b></h4>
                    <p>
                <b><code>stats</code></b>&nbsp;&nbsp;<small>boolean</small>     <i>optional</i> &nbsp;
                <label data-endpoint="GETv1-masternode-with_inactive-all" hidden>
            <input type="radio" name="stats"
                   value="1"
                   data-endpoint="GETv1-masternode-with_inactive-all"
                   data-component="query"             >
            <code>true</code>
        </label>
        <label data-endpoint="GETv1-masternode-with_inactive-all" hidden>
...
<p>Get explainations for all returned values. Default: <code>false</code></p>            </p>
            ...
            <h2 id="masternode-GETv1-masternode-address--address-">Masternode by address</h2>
...
<span id="example-requests-GETv1-masternode-address--address-">
<blockquote>Example request:</blockquote>


<pre><code class="language-bash">curl --request GET \
    --get "https://defichain-api.io/v1/masternode/address/8MPzdvvBrZ4SLjy5Ymq37wKxYftECKjWa3?stats=1&amp;wtf=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>

<pre><code class="language-php">$client = new \GuzzleHttp\Client();
$response = $client-&gt;get(
    'https://defichain-api.io/v1/masternode/address/8MPzdvvBrZ4SLjy5Ymq37wKxYftECKjWa3',
    [
        'headers' =&gt; [
            'Accept' =&gt; 'application/json',
        ],
...
url = 'https://defichain-api.io/v1/masternode/address/8MPzdvvBrZ4SLjy5Ymq37wKxYftECKjWa3'
params = {
  'stats': '1',
  'wtf': '1',
}
...
<span id="example-responses-GETv1-masternode-address--address-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETv1-masternode-address--address-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETv1-masternode-address--address-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETv1-masternode-address--address-"></code></pre>
</span>
<span id="execution-error-GETv1-masternode-address--address-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETv1-masternode-address--address-"></code></pre>
</span>
<form id="form-GETv1-masternode-address--address-" data-method="GET"
      data-path="v1/masternode/address/{address}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETv1-masternode-address--address-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>v1/masternode/address/{address}</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
                ...
                <input type="text"
               name="address"
               data-endpoint="GETv1-masternode-address--address-"
               data-component="url" required  hidden>
    <br>
<p>either the owner address, operator address or the masternode id.</p>            </p>
                    ...
                    <p>
                <b><code>stats</code></b>&nbsp;&nbsp;<small>boolean</small>     <i>optional</i> &nbsp;
                <label data-endpoint="GETv1-masternode-address--address-" hidden>
            <input type="radio" name="stats"
                   value="1"
                   data-endpoint="GETv1-masternode-address--address-"
                   data-component="query"             >
